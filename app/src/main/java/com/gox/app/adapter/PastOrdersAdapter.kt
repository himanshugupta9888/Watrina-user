...
class PastOrdersAdapter(val activity: Context?, val transportHistory: TransportResponseData
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        when (servicetype) {
            Constant.ModuleTypes.TRANSPORT -> {
                ...
                holder.pastOderItemlistBinding.itemClickListener = object : CustomClickListener {
    ...
    private fun updateHistoryUi(holder: MyViewHolder, order: String, status: Boolean, booking_id: String, rating: Double
        ...
        if (status) {
            ...
            holder.pastOderItemlistBinding.statusPastTv.background = ContextCompat.getDrawable(activity!!,
                    R.drawable.custom_round_corner_completd)
            holder.pastOderItemlistBinding.statusPastTv.setTextColor(ContextCompat.getColor(activity,
