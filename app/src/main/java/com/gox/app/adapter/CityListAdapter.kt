...
class CityListAdapter(val activity: FragmentActivity?, val citylist: List<City>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflate = DataBindingUtil.inflate<CountrySearchListItemBinding>(
                LayoutInflater.from(parent.context),
                R.layout.country_search_list_item, parent,
                false
        )
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.bind()
        holder.currentOderItemlistBinding.itemClickListener = object : CustomClickListener {
